    ...
    <ul class="navbar-nav hk-navbar-content order-xl-2">
        ...
        <li class="nav-item dropdown dropdown-authentication">
            ...
            <div class="dropdown-menu dropdown-menu-right" data-dropdown-in="flipInX" data-dropdown-out="flipOutX">
                <a class="dropdown-item" href="{{ route('profiles.index') }}"><i class="dropdown-icon zmdi zmdi-account"></i><span>Profile</span></a>
                <a class="dropdown-item" href="{{ route('profiles.create') }}"><i class="dropdown-icon zmdi zmdi-card"></i><span>My balance</span></a>
