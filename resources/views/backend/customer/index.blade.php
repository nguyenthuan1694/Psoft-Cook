...
@section('content')
    ...
    <div class="container-fluid px-xxl-65 px-xl-20">
        ...
        <div class="hk-pg-header">
            <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="external-link"></i></span></span>List of customer</h4>
        </div>
        <!-- /Title -->
                                    ...
                                    @foreach($customers as $index => $items)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <form name="trash_{{ $index }}" action="{{ route('customers.destroy', ['customer' => $items]) }}" method="post">
                                                    @csrf
                                                    @method('DELETE')
                                                </form>
                                            </td>
